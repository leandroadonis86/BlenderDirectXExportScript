...
bl_info = {
    ...
    "author": "Leandro Silva, Omari*, Chris*",
    "version": (3, 1, 5),
    "blender": (2, 69, 0),
    "location": "File > Export > DirectX 8++ (.x)",
    "description": "Export mesh vertices, UV's, materials, textures, "
                   "vertex colors, armatures, empties, actions, and vertex duplicates.",
...
def menu_func(self, context):
    self.layout.operator(ExportDirectX.bl_idname, text="DirectX 8++ (.x)")
